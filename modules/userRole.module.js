...
class _userRole{
    ...
    listUserRole = async()=>{
        try {
            ...
            return{
                status: true, code: 200, data: list,
            }
        } catch (error) {
    ...
    createUserRole = async (body) => {
        try {
            ...
            if (validation.error) {
                ...
                return{
                    status: false, code: 422, error: errorDetails.join(', ')
                }
            }
    ...
    detailUserRole = async(id)=>{
        try {
            ...
            return{
                status: true, code: 200, data: detail
            }
        } catch (error) {
